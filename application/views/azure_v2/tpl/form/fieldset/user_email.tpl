<div class="form-group[{if $aErrors.oxuser__oxusername}] oxInValid[{/if}]">
    <label class="req control-label col-lg-3">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_EMAIL"}]</label>
    <div class="col-lg-9">
...
<div class="oxValidate_pwd form-group[{if $aErrors.oxuser__oxpassword}] oxInValid[{/if}]" [{if !$aErrors.oxuser__oxpassword}]style="display:none;"[{/if}]>
    <label class="req control-label col-lg-3">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_PWD"}]</label>
    <div class="col-lg-9">

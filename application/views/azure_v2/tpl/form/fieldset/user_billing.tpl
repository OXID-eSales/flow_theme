...
<div class="form-group">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxsal)}] req[{/if}]" for="invadr_oxuser__oxfname">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_TITLE"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxfname}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxfname)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_FIRSTNAME"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxlname}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxlname)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_LASTNAME"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxcompany}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxcompany)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_COMPANY"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxaddinfo}] text-danger[{/if}]">
    ...
    <label [{if $_address_addinfo_tooltip}]title="[{$_address_addinfo_tooltip}]"[{/if}] class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxaddinfo)}] req[{/if}][{if $_address_addinfo_tooltip}] tooltip[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_ADDITIONALINFO"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxstreet}] text-danger[{/if}]">
    <label class="control-label col-xs-12 col-lg-3[{if $oView->isFieldRequired(oxuser__oxstreet) || $oView->isFieldRequired(oxuser__oxstreetnr)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_STREETANDSTREETNO"}]</label>
...
<div class="form-group[{if $aErrors.oxuser__oxzip}] text-danger[{/if}]">
    <label class="control-label col-xs-12 col-lg-3[{if $oView->isFieldRequired(oxuser__oxzip) || $oView->isFieldRequired(oxuser__oxcity)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_POSTALCODEANDCITY"}]</label>
...
<div class="form-group[{if $aErrors.oxuser__oxustid}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxustid)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_VATIDNO"}]</label>
    <div class="col-lg-9">
...
[{block name="form_user_billing_country"}]
    <div class="form-group[{if $aErrors.oxuser__oxcountryid}] text-danger[{/if}]">
        <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxcountryid)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_COUNTRY"}]</label>
        <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxfon}] text-danger"[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxfon)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_PHONE"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxfax}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxfax)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_FAX"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxmobfon}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxmobfon)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_CELLUARPHONE"}]</label>
    <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxprivfon}] text-danger[{/if}]">
    <label class="control-label col-lg-3[{if $oView->isFieldRequired(oxuser__oxprivfon)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_EVENINGPHONE"}]</label>
    <div class="col-lg-9">
...
[{if $oViewConf->showBirthdayFields()}]
    <div class="form-group oxDate[{if $aErrors.oxuser__oxbirthdate}] text-danger[{/if}]">
        <label class="control-label col-xs-12 col-lg-3[{if $oView->isFieldRequired(oxuser__oxbirthdate)}] req[{/if}]">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_BIRTHDATE"}]</label>
...
[{if !$noFormSubmit}]
    <div class="form-group">
        <div class="col-lg-offset-3 col-lg-9 col-xs-12">
            <button id="accUserSaveTop" type="submit" name="save" class="btn btn-primary">[{oxmultilang ident="FORM_FIELDSET_USER_BILLING_SAVE"}]</button>
        </div>
    </div>
[{/if}]
<div class="form-group[{if $aErrors.oxuser__oxusername}] oxInValid[{/if}]">
    [{block name="user_account_username"}]
        <label class="control-label col-lg-3 req" for="userLoginName">[{oxmultilang ident="FORM_FIELDSET_USER_ACCOUNT_EMAIL"}]</label>
        <div class="col-lg-9">
...
<div class="form-group[{if $aErrors.oxuser__oxpassword}] oxInValid[{/if}]">
    [{block name="user_account_password"}]
        <label class="control-label col-lg-3 req" for="userPassword">[{oxmultilang ident="FORM_FIELDSET_USER_ACCOUNT_PWD"}]</label>
...
<div class="form-group[{if $aErrors.oxuser__oxpassword}] oxInValid[{/if}]">
    [{block name="user_account_confirmpwd"}]
        <label class="control-label col-lg-3 req">[{oxmultilang ident="FORM_FIELDSET_USER_ACCOUNT_CONFIRMPWD"}]</label>
        <div class="col-lg-9">

...
<form class="form-horizontal" action="[{$oViewConf->getSslSelfLink()}]" method="post" role="form" novalidate="novalidate">
    ...
    <div class="form-group">
        <label class="control-label col-lg-2">[{oxmultilang ident="FORM_NEWSLETTER_TITLE"}]</label>
    ...
    <div class="form-group">
        <label class="control-label col-lg-2">[{oxmultilang ident="FORM_NEWSLETTER_LASTNAME"}]</label>
    ...
    <div class="form-group[{if $aErrors}] oxInValid[{/if}]">
        <label class="req control-label col-lg-2">[{oxmultilang ident="FORM_NEWSLETTER_EMAIL"}]</label>
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-5">
            <label for="newsletterSubscribeOn" class="checkbox-inline">
                <input id="newsletterSubscribeOn" type="radio" name="subscribeStatus" value="1" checked> [{oxmultilang ident="FORM_NEWSLETTER_SUBSCRIBE"}]
            </label>
            <label for="newsletterSubscribeOff" class="checkbox-inline">
                <input id="newsletterSubscribeOff" type="radio" name="subscribeStatus" value="0"> [{oxmultilang ident="FORM_NEWSLETTER_UNSUBSCRIBE"}]
            </label>
        </div>
    </div>
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-5">
            <p class="alert alert-info">[{oxmultilang ident="FORM_NEWSLETTER_COMPLETEMARKEDFIELDS"}]</p>

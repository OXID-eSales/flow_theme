<form action="[{$oViewConf->getSelfActionLink()}]" name="saverecommlist" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        <label class="control-label col-lg-3 req">[{oxmultilang ident="FORM_RECOMMENDATION_EDIT_LISTTITLE"}]</label>
        <div class="col-lg-9">
            <input type="text" name="recomm_title" class="form-control" maxlength="73" value="[{$actvrecommlist->oxrecommlists__oxtitle->value}]">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-lg-3">[{oxmultilang ident="FORM_RECOMMENDATION_EDIT_LISTAUTHOR"}]</label>
        <div class="col-lg-9">
    ...
    <div class="form-group">
        <label class="control-label col-lg-3">[{oxmultilang ident="FORM_RECOMMENDATION_EDIT_LISTDESC"}]</label>
        <div class="col-lg-9">
    ...
    <div class="form-group">
        <div class="col-lg-offset-3 col-lg-9">
            <button class="btn btn-primary" type="submit">[{oxmultilang ident="FORM_RECOMMENDATION_EDIT_SAVE"}]</button>
            [{if $_actvrecommlist}]

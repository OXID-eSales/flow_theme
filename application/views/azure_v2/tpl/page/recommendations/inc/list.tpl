                ...
                <li>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <small class="text-muted">[{oxmultilang ident="PAGE_RECOMMENDATIONS_PRODUCTS_LISTBY"}] <strong>[{$recommlist->oxrecommlists__oxauthor->value}]</strong></small>
                            ...
                            [{if $blEdit}]
                                <form action="[{$oViewConf->getSelfActionLink()}]" method="post" class="form-inline pull-right">
                                    ...
                                    <button class="btn btn-warning btn-xs hasTooltip" type="submit" name="editList" title="[{oxmultilang ident="PAGE_RECOMMENDATIONS_LIST_EDIT"}]">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                    <button class="btn btn-danger btn-xs hasTooltip" type="submit" name="deleteList" value="1" title="[{oxmultilang ident="PAGE_RECOMMENDATIONS_LIST_REMOVE"}]">
...
[{else}]
    <p class="alert alert-info">[{oxmultilang ident="PAGE_RECOMMENDATIONS_LIST_NOLISTS"}]</p>
[{/if}]
    ...
    [{block name="checkout_thankyou_main"}]
        ...
        <div id="thankyouPage">
            ...
            [{block name="checkout_thankyou_proceed"}]
                ...
                <a id="backToShop" href="[{oxgetseourl ident=$oViewConf->getHomeLink()}]" class="link">[{oxmultilang ident="PAGE_CHECKOUT_THANKYOU_BACKTOSHOP"}]</a>
                [{if $oxcmp_user->oxuser__oxpassword->value}]
                    [{oxmultilang ident="PAGE_CHECKOUT_THANKYOU_OR"}]
                    <a id="orderHistory" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account_order"}]" class="link">[{oxmultilang ident="PAGE_CHECKOUT_THANKYOU_ORDERHISTORY"}]</a>.
                [{/if}]
            [{/block}]

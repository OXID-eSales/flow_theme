[{capture append="oxidBlock_content"}]
    ...
    <h1 class="page-header">[{oxmultilang ident="PAGE_INFO_SUGGEST_TITLE"}]</h1>
    <ul>
    ...
    [{oxifcontent ident="oxsecurityinfo" object="oCont"}]
        <p>[{oxmultilang ident="PAGE_INFO_SUGGEST_ABOUTDATAPROTECTION"}] <a href="[{$oCont->getLink()}]">[{$oCont->oxcontents__oxtitle->value}]</a></p>
    [{/oxifcontent}]

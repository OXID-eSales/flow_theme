...
$aLang = array(
    ...
    'EMAIL_ORDER_CUST_HTML_ARTNOMBER'                     => 'Prod.no.',
    ...
    'EMAIL_ORDER_CUST_HTML_PLUSTAX1'                      => "incl. VAT",
    'EMAIL_ORDER_CUST_HTML_PLUSTAX21'                     => "incl. VAT",
    'EMAIL_ORDER_CUST_HTML_SHIPPINGCARRIER'               => "Delivered with",
    'EMAIL_ORDER_CUST_HTML_SHIPPINGNET'                   => "Shopping costs (net):",
    'EMAIL_ORDER_CUST_HTML_TAX1'                          => "incl. VAT",
    'EMAIL_ORDER_CUST_HTML_TSPROTECTIONCHARGETAX1'        => "incl. VAT",
    'EMAIL_ORDER_OWNER_HTML_MESSAGE'                      => "Notes:",
    ...
    'EMAIL_SUGGEST_HTML_MENYGREETINGS'                    => "Best regards,",
    ...
    'FORM_CONTACT_SEND'                                   => "Send message",
    ...
    'FORM_REGISTER_IAGREETOTERMS3'                        => "and accept them.",
    ...
    'FORM_PRIVATESALES_INVITE_SENDEREMAIL'                => "Your email:",
    'FORM_RECOMMENDATION_EDIT_LISTTITLE'                  => "Heading",
    ...
    'NEWSLETTER_COMPLETEALLFIELEDS'                       => "Please fill out all required fields!",
    'MESSAGE_NEWSLETTER_SENT_CONFIRMATION'                => 'You shall have received an e-mail in order to opt-in to our newsletter.',
    'PAGE_ACCOUNT_DASHBOARD_LOGOUT'                       => "LOGOUT",
    'PAGE_ACCOUNT_FORGOTPWD_UPDATEPASSWORD'               => "Save new password",
    'PAGE_ACCOUNT_REGISTER_OPENACCOUNT'                   => "Create new account",
    ...
    'PAGE_CHECKOUT_BASKETCONTENTS_COUPONNOTACCEPTED2'     => "has been rejected.",
    'PAGE_CHECKOUT_BASKETCONTENTS_GRANDTOTAL'             => "Grand total",
    'PAGE_CHECKOUT_BASKETCONTENTS_PAYMENTTAX1'            => "Surcharge VAT",
    'PAGE_CHECKOUT_BASKETCONTENTS_PAYMENTTAX2'            => "% total",
    'PAGE_CHECKOUT_BASKETCONTENTS_PLUSTAX1'               => "incl. VAT",
    'PAGE_CHECKOUT_BASKETCONTENTS_PLUSTAX2'               => "% total",
    'PAGE_CHECKOUT_BASKETCONTENTS_REASON'                 => "Reason",
    'PAGE_CHECKOUT_BASKETCONTENTS_TAX1'                   => "incl. VAT",
    'PAGE_CHECKOUT_BASKETCONTENTS_TAX2'                   => "% total",
    'PAGE_CHECKOUT_BASKETCONTENTS_TOTAL'                  => "Grand total",
    'PAGE_CHECKOUT_BASKETCONTENTS_TOTALGROSS'             => "total articles (brut)",
    'PAGE_CHECKOUT_BASKETCONTENTS_TOTALNET'               => "total articles (net)",
    'PAGE_CHECKOUT_BASKETCONTENTS_TSPROTECTIONCHARGETAX1' => "incl. VAT",
    'PAGE_CHECKOUT_BASKETCONTENTS_WRAPPINGTAX1'           => "incl. VAT",
    ...
    'PAGE_CHECKOUT_ORDER_COUPONNOTACCEPTED2'              => "has been rejected.",
    'PAGE_CHECKOUT_ORDER_SHIPPINGADDRESS'                 => "Delivery address",
    'PAGE_CHECKOUT_PAYMENT_ACCOUNTNUMBER'                 => "Account no:",
    'PAGE_CHECKOUT_PAYMENT_COMLETEALLFIELDS'              => "Pleas fill out all fields correctly!",
    ...
    'PAGE_INFO_NEWS_LATESTNEWSBY'                         => "News in",
    ...
    'EMAIL_ORDER_CUST_HTML_PLUSTAX2'                      => "incl. VAT",
    'SHIPPING_VAT1'                                       => "additional VAT",
    'SHIPPING_VAT2'                                       => "% sum:",
    'PAYMENT_INFORMATION2'                                => "Payment is made via:",
    'NEW_PASSWORD2'                                       => "new password",
    'PAGE_CHECKOUT_USER'                                  => "Send",
);
...
[{if !isset($removeFunction)}][{assign var="removeFunction" value=null}] [{/if}]
[{if !isset($altproduct)}][{assign var="altproduct" value=null}] [{/if}]
[{if !isset($blDisableToCart)}][{assign var="blDisableToCart" value=null}] [{/if}]
[{if !isset($iProductsPerLine)}][{assign var="iProductsPerLine" value=null}] [{/if}]
[{if !isset($header)}][{assign var="header" value=null}] [{/if}]
[{if !isset($head)}][{assign var="head" value=null}] [{/if}]
[{if !isset($showMainLink)}][{assign var="showMainLink" value=null}] [{/if}]
[{if !isset($rsslink)}][{assign var="rsslink" value=null}] [{/if}]
[{if !isset($testid)}][{assign var="testid" value=null}] [{/if}]

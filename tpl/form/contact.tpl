...
<form class="form-horizontal" action="[{$oViewConf->getSslSelfLink()}]" method="post" role="form" novalidate="novalidate">
    ...
    <div class="form-group[{if $aErrors.oxuser__oxfname}] oxInValid[{/if}]">
        ...
        <div class="col-lg-10 controls">
            <input type="text" name="editval[oxuser__oxfname]" size="70" maxlength="80" value="[{$editval.oxuser__oxfname}]" class="form-control" required="required">
        </div>
    </div>
    <div class="form-group[{if $aErrors.oxuser__oxlname}] oxInValid[{/if}]">
        ...
        <div class="col-lg-10 controls">
            <input type="text" name="editval[oxuser__oxlname]" size=70 maxlength=80 value="[{$editval.oxuser__oxlname}]" class="form-control" required="required">
        </div>
    </div>
    <div class="form-group[{if $aErrors.oxuser__oxusername}] oxInValid[{/if}]">
        ...
        <div class="col-lg-10 controls">
            <input id="contactEmail" type="email" name="editval[oxuser__oxusername]"  size=70 maxlength=80 value="[{$editval.oxuser__oxusername}]" class="form-control" required="required">
        </div>
    </div>

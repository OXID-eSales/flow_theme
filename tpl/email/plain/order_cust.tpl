...
[{if $basket->getPayCostNet()}]
    ...
    [{if $basket->getPayCostVat()}]
        [{if $basket->isProportionalCalculationOn()}] [{oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT"}][{else}] [{oxmultilang ident="PLUS_VAT"}] [{$basket->getPayCostVatPercent()}][{oxmultilang ident="SHIPPING_VAT2"}][{/if}] [{$basket->getPayCostVat()}] [{$currency->sign}]
    [{/if}]
...
[{if $basket->getTsProtectionCosts()}]
    [{oxmultilang ident="EMAIL_ORDER_CUST_HTML_TSPROTECTIONCHARGETAX1"}] [{$basket->getTsProtectionVatPercent()}][{oxmultilang ident="SHIPPING_VAT2"}] [{$basket->getTsProtectionVat()}] [{$currency->name}]
    [{if $basket->getTsProtectionVat()}]
        [{if $basket->isProportionalCalculationOn()}][{oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT"}][{else}] [{oxmultilang ident="PLUS_VAT"}] [{$basket->getTsProtectionVatPercent()}][{oxmultilang ident="SHIPPING_VAT2"}][{/if}]
    [{/if}]
[{/if}]
[{/block}]
...
[{if $oViewConf->getShowGiftWrapping()}]
    [{if $basket->getGiftCardCostNet()}]
        ...
        [{if $basket->getGiftCardCostVat()}]
            [{if $basket->isProportionalCalculationOn()}][{oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT"}][{else}] [{oxmultilang ident="PLUS_VAT"}] [{$basket->getGiftCardCostVatPercent()}][{oxmultilang ident="SHIPPING_VAT2"}][{/if}] [{$basket->getGiftCardCostVat()}] [{$currency->sign}]
        [{/if}]
